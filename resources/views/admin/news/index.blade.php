...
<div class="col-md-6">
    ...
    <div class="box box-info">
        ...
        <div class="box-footer clearfix">
            {!! Button::info('Ajouter')->asLinkTo(route('admin.news.create'))->small() !!}
        </div>
        <!-- /.box-footer -->
    </div>
    <!-- /.box -->
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::warning('Modifier')->asLinkTo(route('admin.news.edit', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.news.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
